...
def train(epoch_total,loadstate):
    ...
    if loadstate==True:
        ...
        # checkpoint = torch.load('/home/s1804054/CG_D/checkpoint/ckpt.t7')
        checkpoint = torch.load('/home/ubuntu/CG_D/checkpoint/ckpt.t7')
    ...
    for epoch in range(start_epoch,epoch_total):
        ...
        for step in range(len(dataloader)):
            ...
            if step==len(dataloader)-1:
                ...
                torch.save(state,'/home/ubuntu/CG_D/checkpoint/ckpt.t7')
